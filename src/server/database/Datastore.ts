...
import OriginalDatastore from 'nedb'
export type { Datastore, Cursor } from './types'
...
class Datastore extends EventEmitter {
  ...
  public persistence
  private __original: OriginalDatastore
    ...
    // @see https://github.com/louischatriot/nedb#persistence
    this.__original.persistence.setAutocompactionInterval(
  ...
  close = () => new Promise((resolve, reject) => {
    this.__original.persistence.stopAutocompaction()
    this.__original.persistence.compactDatafile(resolve)
  })
	 ...
	 * @return {Cursor}
	 */
	findOne(query = {}, projection?): Cursor<any[]> {
		if (typeof projection === 'function') {
			projection = {}
		}
	 ...
	 * @return {Proxy.<static>}
	 */
	static create(options): Datastore {
