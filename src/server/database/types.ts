...
export type Cursor<T> = Nedb.Cursor<T>

export type EnsureIndexOptions = Nedb.EnsureIndexOptions
...
export declare class Datastore extends EventEmitter {
  ...
  /**
   * Persitence methods available when created with .create()
   */
   ...
   */
  find<T>(query: any, projection?: {[p in keyof T]?:number}): Promise<(T & Document)[]> // Nedb.Cursor
...
declare namespace Nedb {
   ...
   *
   * @see https://github.com/louischatriot/nedb#indexing
   */
